...
* similar, for example because both datasets contain pictures of animals
...
The goal is to create a dataset of how these concepts are represented (by thematic analysis) in recent ML papers, and to identify and analyze differences, for example across different years or conferences.
